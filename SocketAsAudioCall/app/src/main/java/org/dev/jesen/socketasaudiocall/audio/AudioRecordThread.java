package org.dev.jesen.socketasaudiocall.audio;
...
public class AudioRecordThread extends Thread {
    ...
    public void run() {
        ...
        // 压缩器
        @SuppressLint("WrongConstant") OpusEncoder encoder = new OpusEncoder(AudioContract.SAMPLE_RATE, AudioContract.NUM_CHANNELS, OpusEncoder.OPUS_APPLICATION_VOIP);
